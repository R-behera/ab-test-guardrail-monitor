...
# A/B Test Guardrail Monitor

![Demo Screenshot](demo/screenshot.png)

## Overview
Monitor experiment guardrails, rollout quality, and anomaly thresholds during launches.
...
- Tags: ab-tests, guardrails, launch
